...
def _build_dict():
    ...
    return {
        ...
        "EM_MIN_STEPS_PER_GYRO_ORBIT": EM_MIN_STEPS_PER_GYRO_ORBIT,
        "EM_BORIS_METHOD": EM_BORIS_METHOD,
        "V_RID_V": V_RID_V,
...
def _apply(d):
    ...
    g["EM_MIN_STEPS_PER_GYRO_ORBIT"] = d.get("EM_MIN_STEPS_PER_GYRO_ORBIT", 20)
    g["EM_BORIS_METHOD"]            = d.get("EM_BORIS_METHOD", "exact")
